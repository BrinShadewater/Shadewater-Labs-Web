...
export default function InkMasterStudio({ onNavigate }: InkMasterStudioProps) {
  ...
  const data: ProductPageData = {
    ...
    showcase: [
      { id: 'live-surface', label: 'LIVE SURFACE', title: 'Public beta landing', description: 'The live web surface frames the product around batch processing, print-master sizing, knockout cleanup, and DTG-specific output instead of generic image editing.', tag: 'inkmasterstudio.com', command: 'open https://inkmasterstudio.com', src: '/inkmaster-live-landing.webp', alt: 'InkMaster Studio live landing page showing the upload surface, batch processing entry point, and DTG-focused feature cards.' },
      { id: 'print-master', label: 'GENERATED ASSET', title: '4200 × 5100 print master', description: 'A processed export centered around the standardized print-master canvas that the workflow uses as its production baseline.', tag: 'inkmaster/print-master.png', command: 'upload → prep → download print file', featured: true, src: '/inkmaster-showcase-print-master.webp', alt: 'InkMaster showcase board with a print-master export displayed on a checkerboard transparency surface and key export metadata.' },
      { id: 'mockup-board', label: 'GENERATED ARTIFACT', title: 'Multi-color mockup board', description: 'The same processed design staged across multiple shirt colors to validate contrast, placement, and merchandising readiness before shipping final assets.', tag: 'inkmaster/mockup-board.png', command: 'process → mockup mode → export 4 colors', src: '/inkmaster-showcase-mockup-board.webp', alt: 'InkMaster mockup board showing the same design placed on black, charcoal, and royal blue shirt mockups.' },
      { id: 'underbase', label: 'GENERATED ARTIFACT', title: 'Underbase generation', description: 'Turn processed art into a white underbase layer for dark-garment DTG printing while preserving silhouette and soft alpha information.', tag: 'inkmaster/underbase.png', command: 'process → generate underbase → export PNG', src: '/inkmaster-showcase-underbase.webp', alt: 'InkMaster underbase preview showing the processed source output next to a white underbase version for dark-garment DTG printing.' },
    ],
    comparison: {
      section: {
