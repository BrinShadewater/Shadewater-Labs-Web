...
export const SHADEWATER_LABS_MARK_CROPPED_WIDTH = 417;
export const SHADEWATER_LABS_MARK_CROPPED_HEIGHT = 734;
...
export const SHADEWATER_LABS_MARK_WIDTH = 417;
export const SHADEWATER_LABS_MARK_HEIGHT = 734;
...
export const SHADEWATER_LABS_TEXT_LOGO_WIDTH = 589;
export const SHADEWATER_LABS_TEXT_LOGO_HEIGHT = 853;
