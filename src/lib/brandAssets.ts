...
export const SHADEWATER_LABS_MARK_CROPPED_WIDTH = 520;
export const SHADEWATER_LABS_MARK_CROPPED_HEIGHT = 1180;
...
export const SHADEWATER_LABS_MARK_WIDTH = 1200;
export const SHADEWATER_LABS_MARK_HEIGHT = 900;
...
export const SHADEWATER_LABS_TEXT_LOGO_WIDTH = 1200;
export const SHADEWATER_LABS_TEXT_LOGO_HEIGHT = 900;
